...
<a href="{{ asset('storage/'. $gallery->image) }}" data-featherlight="image" class="col-3 wow fadeIn"
               data-wow-delay="0.1s"><img src="{{ asset('storage/'. $gallery->image) }}" alt="Landing Page"/></a>
@endforeach
    </aside>
    <!--End of Gallery-->
