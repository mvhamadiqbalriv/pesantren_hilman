                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                      <img src="{{ asset('storage/'. $pendaftar->foto_diri) }}" alt="FOTO_PENDAFTAR" class="rounded-circle" width="200" height="150">
                      <div class="mt-3">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-4 mb-3">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <div class="d-flex flex-column align-items-center text-center">
                              <a href="{{ asset('storage/'. $pendaftar->ijazah) }}" data-featherlight="image"
                              data-wow-delay="0.1s"><img src="{{ asset('storage/'. $pendaftar->ijazah) }}" alt="" class="rounded" width="200" height="250"></a>
                            <div class="mt-3">
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="col-sm-4 mb-3">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <div class="d-flex flex-column align-items-center text-center">
                              <a href="{{ asset('storage/'. $pendaftar->kartu_kk) }}" data-featherlight="image"
                              data-wow-delay="0.1s"><img src="{{ asset('storage/'. $pendaftar->kartu_kk) }}" alt="" class="rounded" width="200" height="250"></a>
                            <div class="mt-3">
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="col-sm-4 mb-3">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <div class="d-flex flex-column align-items-center text-center">
                              <a href="{{ asset('storage/'. $pendaftar->akta) }}" data-featherlight="image"
                              data-wow-delay="0.1s"><img src="{{ asset('storage/'. $pendaftar->akta) }}" alt="" class="rounded" width="200" height="250"></a>
                            <div class="mt-3">
                            </div>
                          </div>
                        </div>
